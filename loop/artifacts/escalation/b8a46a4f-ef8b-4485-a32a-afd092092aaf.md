# Escalation Report - Run b8a46a4f-ef8b-4485-a32a-afd092092aaf
...
- **Passed Items**: 0
- **Active Rejections**: 6
- **Timestamp**: 2026-06-22T13:29:22.673243
...
- **Stage**: perspectives
  - **Status**: pre_failed
  - **Attempts**: 15
  - **Last Rejection Reason**: Execution Error: 'STORMWikiLMConfigs' object has no attribute 'set_question_asker_model'
...
3. Resume the execution run with `python -m loop.run --resume b8a46a4f-ef8b-4485-a32a-afd092092aaf`.
