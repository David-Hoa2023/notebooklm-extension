...
- **`run-all` 6 seed** đã chạy thật (~48 phút): PG 0,000, SG 0,000, GG 0,000; H1/H2 **chưa** đạt ý nghĩa thống kê (p = 0.500) do hiệu ứng biên trần.
...
Thách thức tiếp theo: (1) phá vỡ mức trần điểm số 9.0 — cần các bài tập kiểm thử khó ẩn hoặc judge nghiêm ngặt hơn; (2) **skill extraction** — một số bản trích xuất vẫn lỗi định dạng khi lưu; (3) mở rộng độ phủ và độ đa dạng bài tập tự sinh.
